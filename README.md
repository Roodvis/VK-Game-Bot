...
### 1. Получение токенов:
  ...
  2) Получите Standalone APP Access Token, <a href="https://vk.com/dev/implicit_flow_user">детальнее</a> (в параметре display укажите свойства <strong>wall</strong> и <strong>offile</strong>)
